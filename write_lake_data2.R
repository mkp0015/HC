...
vals <- varEntryDialog(vars=c('LakeName', 'Month', 'Day', 'Rainfall', 'PoolElev', 'TailElev',
                              'Discharge', 'Gate1', 'Gate2', 'Gate3', 'Gate4', 'Gate1C1', 'Gate2C1',
                              'Gate3C1', 'Gate4C1', 'Gate1C2', 'Gate2C2', 'Gate3C2', 'Gate4C2', 
                              'GateOp1', 'GateOp2'),
                       labels=c('Lake Name', 'Month', 'Day', 'Rainfall', 'Pool Elevation', 
                                'Tail Elevation', 'Discharge', 'Gate 1 Setting', 'Gate 2 Setting', 
                                'Gate 3 Setting', 'Gate 4 Setting', 'Gate Op 1 Gate 1 Settings', 
                                'Gate Op 1 Gate 2 Settings', 'Gate Op 1 Gate 3 Settings', 'Gate Op 1 Gate 4 Settings',
                                'Gate Op 2 Gate 1 Settings', 'Gate Op 2 Gate 2 Settings', 'Gate Op 2 Gate 3 Settings',
                                'Gate Op 2 Gate 4 Settings', 'Gate Op 1 Description', 'Gate Op 2 Description'),
                       title="Lake Variable Entry")
